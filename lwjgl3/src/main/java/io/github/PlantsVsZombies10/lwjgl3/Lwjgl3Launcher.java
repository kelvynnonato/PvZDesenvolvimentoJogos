package io.github.PlantsVsZombies10.lwjgl3;

import com.badlogic.gdx.backends.lwjgl3.Lwjgl3Application;
import com.badlogic.gdx.backends.lwjgl3.Lwjgl3ApplicationConfiguration;
import io.github.PlantsVsZombies10.Main;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setTitle("Plants vs. Zombies 10");
        ...
        configuration.setWindowedMode(820, 600);
        //// You can change these files; they are in lwjgl3/src/main/resources/ .
        //// They can also be loaded from the root of assets/ .
        configuration.setWindowIcon("pvz icon.png", "pvz icon.png", "pvz icon.png", "pvz icon.png");
